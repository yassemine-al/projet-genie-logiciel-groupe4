...
public class Contact {
    ...
    public Contact(Long id, String name, String email, String phone, String notes) {
        // Validation : on refuse de créer un contact sans nom 
    ...
    // Getters pour que les autres couches puissent lire les informations [cite: 578]
